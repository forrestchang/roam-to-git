...
def main():
    ...
    parser.add_argument(
        "--debug", action="store_true", help="Activate various debug-oriented modes"
    )
    parser.add_argument(
        "--gui",
        action="store_true",
    ...
    parser.add_argument(
        "--browser", default="firefox", help="Browser to use for scrapping in Selenium."
    )
    parser.add_argument(
        "--browser-arg",
